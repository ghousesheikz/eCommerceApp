package com.example.ecommerceapp.custom_classes;
...
public class ElegantNumberButton extends RelativeLayout {
    ...
    private void initView() {
        ...
        final int defaultColor = res.getColor(R.color.yellow);
        final int defaultTextColor = res.getColor(R.color.color_one);


        final Drawable defaultDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.background_, null);
